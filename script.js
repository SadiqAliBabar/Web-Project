...
elem.forEach(function (el) {
  el.addEventListener("mousemove", function () {
    gsap.to(el.querySelector("h1"), {
      opacity: 0.3,
      transform: 'translateX(-5%)',
      ease: 'power2.out', // Use a different easing function for smoother transition
      duration: 1,
      scale: 1,
    });
  });
  ...
  el.addEventListener("mouseleave", function () {
    gsap.to(el.querySelector("h1"), {
      opacity: 1,
      transform: 'translateX(0%)',
      ease: 'power2.inOut', // Use a different easing function for smoother transition
      duration: 1,
      scale: 1,
    });
  });
